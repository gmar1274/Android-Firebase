...
public String getCommentSection(){
    ...
    private void populateAvailableTimes() {
        try {
            ...
            Date open_hour = Utils.getDateFromAGivenTime(today, store.getOpeningHour());//in format of date time
            Date closing_hour = Utils.getDateFromAGivenTime(today, store.getClosingHour());//end bounds
